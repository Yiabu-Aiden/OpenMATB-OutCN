...
# Read the configuration file (relative to the project root)
config = configparser.ConfigParser()
config_path = BASE_DIR / "config.ini"
if not config_path.exists():
    raise FileNotFoundError(f"Missing config.ini at {config_path}")
...
LOCALE_PATH = BASE_DIR.joinpath('locales')
